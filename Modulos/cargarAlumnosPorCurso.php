...
//$id_curso = $_POST['id_curso'];  // Curso seleccionado

try {
    // Consulta para obtener los alumnos inscritos en el curso
    ...
    echo json_encode(['status' => 'error', 'message' => 'Error al cargar los alumnos']);
}
?>
